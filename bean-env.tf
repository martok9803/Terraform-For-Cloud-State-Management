resource "aws_elastic_beanstalk_environment" "vprofile-bean-prod" {
  ...
  application         = aws_elastic_beanstalk_application.vprofile_prod.name
  ...
  setting {
    namespace = "aws:autoscalling:asg"
  ...
  setting {
    namespace = "aws:autoscalling:updatepolicy:rollingupdate"
  ...
  depends_on = [aws_security_group.vprofile-bean-elb-sg, aws_security_group.vprofile_prod_sg]
